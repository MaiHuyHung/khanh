<?php
	...
	$data = array();
    /*lấy request zề*/
    $id =   isset($_REQUEST["edit-post-id"]) ? $_REQUEST["edit-post-id"] : 0;
    $title = isset($_REQUEST["edit-post-title"]) ? $_REQUEST["edit-post-title"] : "No Title";
	$description = isset($_REQUEST["edit-post-description"]) ? $_REQUEST["edit-post-description"] : "No Description";
    $current_price = isset($_REQUEST["edit-post-price"]) ? $_REQUEST["edit-post-price"] : "No Price";
    ...
    $sql .= ", `current_price` = '" . sql_str($current_price) . "'";
    $sql .= ", `cost` = '" . sql_str($cost) . "'";
    $sql .= ", `discount` = '" . sql_str($discount) . "'";
    $sql .= ", `category_id` = $category_id " ;
    $sql .= ", `image` = '" . sql_str($img) . "'";
...
<div class="wrapper">
    ...
    <div class="container content">
        <div class="message-edit-post">
            <p>
                Sửa bài thành công , quay về  <a href='/project/details.php?id=<?php echo $id ?>&category_id=<?php echo $category_id ?>'>Trang chi tiết</a> hoặc quay về <a href='/project/manager.php'>Trang quản lý bài viết</a>
            </p>
        </div>
    </div>
    <div class="footer">
