<?php
	...
	$product_category = select_one($sql);

	$nop = 30;
    $offset = $nop * ($p-1);
    $sql = "select * from product where category_id = {$id} limit {$nop} offset {$offset}";
	...
	<div class="content-today">
        <div class="content-mid-eight">
            <div class="body-suggest">
                <div class="content-suggest">
                    <?php foreach($product_list as $category){?>
                        <div class="product-suggest">
                            <a href="/Project/details.php?id=<?php echo $category['id']?>" class="product-wrap">
                                <div class="item-suggest">
                                    <div class="thumbnail">
                                        <div class="style-thumbnail">
                                            <img src="<?php echo $category['image']?>" alt="Helo mấy cưng">
                                        </div>  
                                    </div>   
                                    <div class="info-suggest">
                                        ...
                                        <div class="price-discount">
                                            <span><strong><?php echo $category['price']?></strong></span>
                                        </div>
                                    </div>  
                                </div>
                            </a>
                ...
                <a href="manager.php?p=1" class="btn-primary btn">Trang quản lý</a>
            </div>
        </div>
    </div> 
    <div class="footer">
